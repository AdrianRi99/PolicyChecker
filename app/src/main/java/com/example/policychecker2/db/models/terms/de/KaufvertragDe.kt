...
@Parcelize
@Entity(tableName = "KaufvertragDe")
class KaufvertragDe (
    ...
    override fun clone(): KaufvertragDe
    {
        val stringKaufvertrag = Gson().toJson(this, KaufvertragDe::class.java)
        return Gson().fromJson(stringKaufvertrag, KaufvertragDe::class.java)
    }
}
