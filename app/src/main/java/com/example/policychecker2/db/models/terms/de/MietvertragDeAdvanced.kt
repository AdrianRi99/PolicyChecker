...
@Parcelize
@Entity(tableName = "MietvertragDeAdvanced")
class MietvertragDeAdvanced (
    ...
    override fun clone(): MietvertragDeAdvanced
    {
        val stringMietvertragAdvanced = Gson().toJson(this, MietvertragDeAdvanced::class.java)
        return Gson().fromJson(stringMietvertragAdvanced, MietvertragDeAdvanced::class.java)
    }
}
